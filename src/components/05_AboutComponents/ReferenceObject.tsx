...
export const StaffReferences: Record<number, JSX.Element> = {
    1: 
        ...
        >
            ...
            <main
                className={`
                    h-3/4 flex flex-col justify-center items-center text-[1rem] text-violet-100 easyRead
                `}
            >
                <p
                    className={`
                        w-[95%] h-[8%] font-semibold text-blue-200
                    `}
                >
                ...
                <ul
                    className={`
                        w-[95%] h-[12%] grid grid-cols-2 list-disc px-8 font-semibold text-lime-200
                    `}
                >
                ...
                <p
                    className={`
                        w-[95%] h-[20%] flex items-start text-justify font-semibold 
                    `}
                >
